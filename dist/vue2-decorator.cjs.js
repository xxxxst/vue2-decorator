...
var ComUtil = (function () {
    ...
    ComUtil.vset = function (obj, key, val) {
        return Vue__default['default'].set ? Vue__default['default'].set(obj, key, val) : (obj[key] = val);
    };
    ComUtil.reactive = function (obj) {
        return Vue__default['default'].reactive ? Vue__default['default'].reactive(obj) : Vue__default['default'].observable(obj);
    };
...
function Comp(comps, options) {
    ...
    return function (target) {
        ...
        var OriginVueComp = Component__default['default'](options)(UserComponent);
